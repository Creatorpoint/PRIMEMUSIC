...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "PREMGUPTA2M")
BOT_USERNAME = os.getenv("BOT_USERNAME", "Prime_music07_bot")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/Creatorpoint/PRIMEMUSIC.git")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/PRIME_MUSIC08")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/PRIME_X_CHAT2")
INSTAGRAM = os.getenv("INSTAGRAM", "https://www.instagram.com/prem_gupta_2m?igsh=MWFiNGx5NTl6Y3Npdw==")
YOUTUBE = os.getenv("YOUTUBE", "https://t.me/PRIME_MUSIC08")
GITHUB = os.getenv("GITHUB", "https://github.com/Creatorpoint/PRIMEMUSIC.git")
DONATE = os.getenv("DONATE", "https://github.com/Creatorpoint/PRIMEMUSIC.git")
...
START_IMG_URL = os.getenv("START_IMG_URL", "https://files.catbox.moe/y609qm.jpeg")
